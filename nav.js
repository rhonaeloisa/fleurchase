...
function buildTopNav(activePage) {
  ...
  if (user.role === 'admin') {
    ...
    nav.innerHTML = `
      ...
      <div style="display:flex;align-items:center;gap:8px;margin-left:10px">
        <a class="nav-icon-btn" href="cart.html" title="Cart"><span class="material-icons" style="font-size:20px;vertical-align:middle">shopping_cart</span><span class="cart-badge cart-count">0</span></a>
